...
const btnList = document.querySelector('#show-list');
const showComs = document.querySelector('#show-coms');
const comsBlock = showComs.parentElement;
const showFavs = document.querySelector('#show-favs');
const favsBlock = showFavs.parentElement;
const list = document.querySelector('.comments__list');
const maxSymbols = document.querySelector('.comments__insert-span2');
...
showFavs.addEventListener('click', () => {
    ...
    const removeMe = document.querySelector('#remove-span');
